...
function Todo(){
    ...
    const getTodos = async()=>{
        const res = await axios.get("https://todobackend-gl9f.onrender.com/todos");
        setTodos(res.data);
    }
    ...
    async function addTodo() {
        ...
        await axios.post(
          "https://todobackend-gl9f.onrender.com/todos",
          {text,done:false}
        );
    ...
    async function deleteTodo(id) {
        await axios.delete(`https://todobackend-gl9f.onrender.com/todos/${id}`);
        getTodos();
    }
    ...
    const toggle = async t=>{
        await axios.patch(
          `https://todobackend-gl9f.onrender.com/todos/${t.id}`,
          {done: !t.done}
        )
        getTodos();
    }
